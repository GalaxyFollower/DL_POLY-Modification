...
!**********************************************************************************************************************!
    !Spohr-Heinzinger Pt-H potential with numerical differentiation for gradients.
    else if (keyword=='shhn') then
      keypot = 1001

    !Spohr-Heinzinger Pt-O potential with numerical differentiation for gradients.
    else if (keyword=='shon') then
      keypot = 1002
!**********************************************************************************************************************!
!                                                 End of Modification.                                                 !
!**********************************************************************************************************************!
...
!**********************************************************************************************************************!
    !Scaling Lennar-Jones with numerical differentiation for gradients.
    else if (keyword=='slj') then
      keypot = 903
!**********************************************************************************************************************!
