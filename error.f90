...
!**********************************************************************************************************************!
    else if (kode==9001) then
      write (nrite,'(/,1x,a)') "error - cannot open MMS_ENSEMBLE file."
    else if (kode==9002) then
      write (nrite,'(/,1x,a)') "error - cannot read from MMS_ENSEMBLE file."
    else if (kode==9011) then
      write (nrite,'(/,1x,a)') "error - cannot open smss-tmp-forces-{idnode} file."
    else if (kode==9012) then
      write (nrite,'(/,1x,a)') "error - cannot write to smss-tmp-forces-{idnode} file."
    else if (kode==9021) then
      write (nrite,'(/,1x,a)') "error - failed to locate $MMS_SHIFTS section in MMS_ENSEMBLE file."
    else if (kode==9022) then
      write (nrite,'(/,1x,a)') "error - no atom in $MMS_SHIFTS section of MMS_ENSEMBLE file."
    else if (kode==9023) then
      write (nrite,'(/,1x,a)') "error - out-of-range indices for SMSS ensemble atom(s)."
    else if (kode==9024) then
      write (nrite,'(/,1x,a)') "error - invalid SMSS ensemble size."
!**********************************************************************************************************************!
!                                                 End of Modification.                                                 !
!**********************************************************************************************************************!
